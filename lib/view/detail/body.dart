...
import 'package:shop_shoes_app/animation/fadeanimation.dart';
import 'package:shop_shoes_app/data/dummy_data.dart';
import 'package:shop_shoes_app/models/shoe_model.dart';
import 'package:shop_shoes_app/theme/custom_app_theme.dart';
import 'package:shop_shoes_app/utils/app_methods.dart';
              ...
              child: Center(
                child: Row(
                  ...
                  children: [
                    ...
                    RotatedBox(quarterTurns: -1, child: FaIcon(FontAwesomeIcons.shoePrints))
                  ],
                ),
              ),
            ),
                  ...
                  itemBuilder: (ctx, index) {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(10),
                          border: Border.all(color: _isSelectedSize == index ? Colors.black : Colors.grey, width: 1.5),
                        ...
                        child: Center(
                          child: Text(
                            ...
                            style:
                                TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: _isSelectedSize == index ? Colors.white : Colors.black),
                          ),
                        ),
                      ),
                    );
          ...
          Container(
            ...
            child: TextButton(
              ...
              child: Text(
                "UK",
                style: TextStyle(
                  fontWeight: _isSelectedCountry ? FontWeight.w400 : FontWeight.bold,
                  color: _isSelectedCountry ? Colors.grey : AppConstantsColor.darkTextColor,
                  fontSize: 19,
                ),
              ),
            ),
          ...
          Container(
            ...
            child: TextButton(
              ...
              child: Text(
                "USA",
                style: TextStyle(
                  fontWeight: _isSelectedCountry ? FontWeight.bold : FontWeight.w400,
                  color: _isSelectedCountry ? AppConstantsColor.darkTextColor : Colors.grey,
                  fontSize: 20,
                ),
              ),
            ),
  ...
  moreDetailsText(width, height) {
    return FadeAnimation(
      ...
      child: Container(
        ...
        height: height / 26,
        child: FittedBox(child: Text('MORE DETAILS', style: AppThemes.detailsMoreText)),
      ),
    );
  }
    ...
    return FadeAnimation(
      ...
      child: Row(
        children: [
          ...
          Text('\$${widget.model.price.toStringAsFixed(2)}', style: AppThemes.detailsProductPrice),
        ],
      ),
    );
  }
